...
const CATEGORY_PALETTE_SETS = {
  ...
  // mixed mid-to-dark tones 'classic'/'noir' both use.
  pastel: {
  ...
  // Unchanged since the first pass — the project owner explicitly singled
  // this set out as the one part of Ember they actually like (the
  // Desk & Ledger and UI Colors sets for Ember were both overhauled into
  // an autumnal mood instead; this stayed exactly as-is by contrast). All
  // 9 original colors kept at their exact original values; 3 new ones (a
  // deeper terracotta,
...
const DESK_PAPER_PRESET_SETS = {
  ...
  // (harvest-gold/pumpkin/maple, under warm cream-to-parchment paper) plus
