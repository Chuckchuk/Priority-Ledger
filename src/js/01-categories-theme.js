...
const UI_COLOR_PRESETS = [
  ...
  // Was "Teal & Rust" — changed to Brass per the project owner's own ask
  // (one of Forest & Rust / Teal & Rust should switch its Rust to Brass;
  // Forest & Rust couldn't, since that would have just duplicated Forest
  // & Brass exactly — Teal had no Brass sibling yet, so this is the one).
  { id:'teal',      label:'Teal & Brass',      primary:'#2C5C58', primaryLight:'#3B7C77', secondary:'#A9782F', secondaryLight:'#C99A4E' },
